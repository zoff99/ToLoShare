 ...
 * @author Manuel Stahl
 */
public class MyLocationNewOverlayTweak extends Overlay implements IOverlayMenuProvider, Overlay.Snappable
{
    ...
    public MyLocationNewOverlayTweak(MapView mapView)
    {
        super();
